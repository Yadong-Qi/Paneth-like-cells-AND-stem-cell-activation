...
# Paneth-like cell in Spatial transcriptomics and single-cell transcriptome data code for GSE125970 and GSE158328
...
library(ggplot2)
SpatialFeaturePlot(Spatial_A1_adult_with_predictions, features = "nCount_Spatial") + theme(legend.position = "right")

SpatialFeaturePlot(Spatial_A1_adult_with_predictions, features = c("LGR5", "LYZ","REG4"))
SpatialFeaturePlot(Spatial_A2_adult_with_predictions, features = c("LGR5", "LYZ","REG4"))
